...
<header class="header-wrapper">
    <div class="container">
        <!-- Logo link-->
        <a href='/' class="logo">
            <img alt='logo' width="210" height="210" src="/images/logo.png">
<%--            <span width="210" height="210" class="btn btn--sign">HAC Cinema</span>--%>
        </a>
        ...
        <div class="control-panel">
            <%
                if (request.getRemoteUser() != null) {
                    ...
                    out.print("<a href=\"/register\" class=\"btn btn--sign\">Sign Up</a>");
                }
            %>
